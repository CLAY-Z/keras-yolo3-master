...
def detect_video(yolo, video_path, output_path=""):
    ...
    # 保存设置
    video_FourCC = int(vid.get(cv2.CAP_PROP_FOURCC))  # 4-character code of codec，codec类型分别为MPEG4和H264
    video_fps = vid.get(cv2.CAP_PROP_FPS)  # Frame rate，得到相机的FPS
    video_size = (int(vid.get(cv2.CAP_PROP_FRAME_WIDTH)),  # Width of the frames in the video stream
                        int(vid.get(cv2.CAP_PROP_FRAME_HEIGHT)))  # Height of the frames in the video stream
